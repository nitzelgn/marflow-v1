  ...
  const AUTH_CSS = `
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    @media(min-width:900px){
      .mf-desktop-layout{flex-direction:column!important;}
    ...
    <div style={{minHeight:"100vh",background:"#060e1c",display:"flex",flexDirection:"row-reverse",fontFamily:"'Poppins',sans-serif",position:"relative",overflow:"hidden"}}>
      ...
      <div className="mf-desktop-layout" style={{flex:1,display:"flex",flexDirection:"row",position:"relative",zIndex:1,minHeight:"100vh"}}>
        ...
        <div className="mf-brand-panel" style={{
          display:"flex", // se muestra por media query
          flex:"0 0 52%",flexDirection:"row-reverse",
...
<div style={{ animation: "fadeIn .8s ease" }}>
  ...
  <div style={{ marginBottom: 20 }}>
    <div style={{
      ...
      La plataforma inteligente que convierte seguimiento en resultados.
      
    Diseñada para asesores de alto rendimiento que operan con precisión y cierran con consistencia.
    </div>
  </div>
</div>
          {/* Features */}
          <div style={{animation:"fadeUp .9s ease",animationDelay:".2s",animationFillMode:"both"}}>
            ...
            gap:20,
              ...
              {[
                {icon:"*",t:"Mensajes y llamadas en un clic",d:"Segmenta y acciona con facilidad."},
                {icon:"📅",t:"Optimiza tus dias",d:"Trabajo, vida personal y viajes en una sola agenda inteligente"},
                {icon:"📊",t:"Decisiones en tiempo real",d:"Métricas claras para actuar sin adivinar"},
                {icon:"💰",t:"Ingresos protegidos",d:"Cobranza y renovaciones bajo control, sin fugas"},
              ]
              .map((f, i ) => (

            
                <div key={f.t} onMouseEnter={(e)=>{
  e.currentTarget.style.boxShadow="0 0 24px rgba(198,169,107,.35)";
  e.currentTarget.style.border="1px solid rgba(198,169,107,.55)";
...
style={{padding:"16px",borderRadius:10,background:"rgba(255,255,255,0.04)",border:"1px solid rgba(198,169,107,0.1)"}}>
  ...
  <img 
    ...
    style={{ 
      ...
      objectFit: "contain",
      marginBottom: 24,
      filter: "drop-shadow(0 8px 24px rgba(198,169,107,0.45))"
    }} 
  />
  ...
  <div style={{
    ...
    Bienvenido
      ...
      <style>{`
        @keyframes spin{to{transform:rotate(360deg)}}
        @media(min-width:900px){
          .mf-brand-panel{display:flex-direction:column!important;}
